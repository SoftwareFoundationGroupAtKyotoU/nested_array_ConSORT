...
make eval-all       # Full evaluation: reproduce all tables from the paper
...
make eval-table4    # Reproduce Table 4 (Z3 Version Comparison)
make eval-table5    # Reproduce Table 5 (Z3 Version Summary)
```
