...
(on ARM64, Z3~4.12.4 is used in place of 4.11.2 because no pre-built arm64 Linux binary exists for 4.11.2 and building it from source requires prohibitive amounts of memory in Docker).
