...
%% TODO: Update artifact DOI from Zenodo when assigned
% \relatedversiondetails{Artifact (Software Heritage)}{https://archive.softwareheritage.org/swh:1:dir:XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX}
...
\begin{itemize}
  ...
  \item \textbf{Table~4}: Z3 version comparison (4.14.1 vs.\ 4.11.2) across all 35 benchmarks.
...
(longer on ARM64, where Z3~4.11.2 is compiled from source via opam).
