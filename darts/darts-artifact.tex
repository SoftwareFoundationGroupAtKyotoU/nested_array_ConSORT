...
\author{Author 1}{Affiliation}{email@example.com}{https://orcid.org/0000-0000-0000-0000}{}
\author{Author 2}{Affiliation}{email@example.com}{https://orcid.org/0000-0000-0000-0000}{}

\authorrunning{Author 1 and Author 2}

\Copyright{Author 1 and Author 2}
...
\RelatedArticle{Author 1 and Author 2, ``Ownership Refinement Types for Pointer Arithmetic and Nested Arrays'', in Proceedings of ECOOP 2026, LIPIcs, Vol.~XXX, pp.~YY:1--YY:ZZ, 2026.\newline \url{https://doi.org/10.4230/LIPIcs.ECOOP.2026.XXX}}
...
reproduce all experimental results (Tables~1--5) from the paper, and a comparison baseline
...
\begin{itemize}
  ...
  \item \textbf{Table~4}: Mean verification time over 10 runs with Z3 versions 4.11.2 and 4.14.1.
  \item \textbf{Table~5}: Summary of Z3 version comparison (derived from Table~4).
\end{itemize}
...
\begin{itemize}
  \item A pre-built Docker image (\texttt{nested-array-consort:ecoop26}) containing:
    \begin{itemize}
      ...
      \item Evaluation scripts for reproducing Tables~1--5
    \end{itemize}
...
This runs a subset of benchmarks from Tables~1, 3, and 4 and prints a pass/fail summary.
...
This takes approximately 2--4 hours (Table~4 dominates with 700 verification runs).
...
Table~4 & \texttt{eval/table4.sh} & \texttt{eval/results/table4.md} & $\sim$1--3 hours \\
Table~5 & \texttt{eval/table5.sh} & \texttt{eval/results/table5.md} & $<$1 min \\
\hline
\end{tabular}
\end{center}

For a faster Table~4 evaluation (2 runs instead of 10):
...
\begin{itemize}
  ...
  \item \textbf{Z3 version comparison trends} (Table~5) should be directionally consistent.
