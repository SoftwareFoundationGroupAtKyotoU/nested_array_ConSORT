...
Note: Building from source requires an internet connection (to download Z3, hoice, and Extended_ConSORT) and may take 10-15 minutes. On ARM64, Z3 4.12.4 is used in place of 4.11.2 (no pre-built arm64 Linux binary exists for 4.11.2); timing results for the "Z3 4.11.2" column in Tables 4 and 5 may differ slightly from the paper on ARM64.
